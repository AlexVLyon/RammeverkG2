...
public class RenderBatch {
    ...
    private void loadVertexProperties(int index) {
        ...
        for (int i = 0; i < 4; i++) {
            ...
            // Load position
            vertices[offset] = sprite.entity.Gettransform.position.x + (xAdd * sprite.entity.Gettransform.scale.x);
            vertices[offset + 1] = sprite.entity.Gettransform.position.y + (yAdd * sprite.entity.Gettransform.scale.y);
